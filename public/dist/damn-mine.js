...
var _knockout = __webpack_require__(18);
...
var Damn = function () {
  ...
  */
	...
	_createClass(Damn, [{
		key: 'run',
		value: function run() {
			var koRootNode = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;

			_knockout2.default.applyBindings({ app: this }, koRootNode);
		}
   ...
   */
		...
		key: 'initKoLoaders',
		value: function initKoLoaders() {
			_knockout2.default.components.getComponentNameForNode = function (node) {
				var tagNameLower = node.tagName && node.tagName.toLowerCase();
				var prefix = 'damn-';

				if (_knockout2.default.components.isRegistered(tagNameLower)) {
					return tagNameLower;
			...
			_knockout2.default.components.loaders.unshift({
				getConfig: function getConfig(name, callback) {
					var pathParts = name.split('-').slice(1),
					    componentName = pathParts[pathParts.length - 1],
					    path = pathParts.join('/');

					var viewModel = __webpack_require__(30)("./" + path + '/' + componentName + '.js').default,
					    template = __webpack_require__(29)("./" + path + '/' + componentName + '.html');

					callback({ viewModel: viewModel, template: template });
				},
				loadViewModel: function loadViewModel(name, viewModelConstructor, callback) {
...
var _damn = __webpack_require__(1);

var _damn2 = _interopRequireDefault(_damn);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var app = new _damn2.default();
...
var AbstractComponent = function AbstractComponent(params) {
...
var RootComponent = function (_AbstractComponent) {
	_inherits(RootComponent, _AbstractComponent);
...
var TasksComponent = function (_AbstractComponent) {
	_inherits(TasksComponent, _AbstractComponent);

	function TasksComponent(params) {
		_classCallCheck(this, TasksComponent);

		var _this = _possibleConstructorReturn(this, (TasksComponent.__proto__ || Object.getPrototypeOf(TasksComponent)).call(this, params));

		_this.tasks = _utils2.default.rewrap(params.tasks);
		return _this;
	}
...
var Utils = function () {
	...
	_createClass(Utils, null, [{
		key: 'rewrap',
		value: function rewrap(object) {
			var result = void 0;

			if (object instanceof Array) {
				result = _knockout2.default.observableArray(object);
			} else if (_knockout2.default.isObservable(object) || _knockout2.default.isComputed(object)) {
				result = object;
			} else {
				result = _knockout2.default.pureComputed(function () {
					return object;
				});
			}
...
module.exports = "<div class=\"container\">\r\n\t<damn-ui-tasks params=\"tasks: ko.observable('asfasf')()\"></damn-ui-tasks>\r\n</div>";
