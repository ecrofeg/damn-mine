		...
		value: function initKoLoaders() {
			...
			_knockout2.default.components.loaders.unshift({
				getConfig: function getConfig(name, callback) {
					...
					var componentName = pathParts[pathParts.length - 1];
					var path = pathParts.join('/');

					callback({
						viewModel: __webpack_require__(24)("./" + path + '/' + componentName + '.js').default,
						template: __webpack_require__(23)("./" + path + '/' + componentName + '.html')
					});
				},
...
module.exports = "<div class=\"container\">\r\n\t<h1>Some testing</h1>\r\n\r\n\t<div class=\"form-group label-static\">\r\n\t\t<input type=\"email\" class=\"form-control\">\r\n\t</div>\r\n\r\n\t<button class=\"btn btn-raised btn-default\">It's my button!</button>\r\n</div>";
...
var _damn = __webpack_require__(4);

var _damn2 = _interopRequireDefault(_damn);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var app = new _damn2.default(document.getElementById('root'));
