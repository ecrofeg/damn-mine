		...
		value: function initKoLoaders() {
			...
			_knockout2.default.components.loaders.unshift({
				getConfig: function getConfig(name, callback) {
					...
					var viewModel = __webpack_require__(27)("./" + path + '/' + componentName + '.js').default,
					    template = __webpack_require__(26)("./" + path + '/' + componentName + '.html');
...
var _damn = __webpack_require__(3);
